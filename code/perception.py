...
def update_beams_reading(Rover):
    """
    Generates new beam readings to locate obstacles around the Rover.
    Averages those reading on the left side of the Rover and generate a normal vector from it.
    This normal vector can be used to take smarter decision and follow the wall.
    """
    xpos, ypos = Rover.pos
    yaw = Rover.yaw
