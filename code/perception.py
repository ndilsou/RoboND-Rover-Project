...
def perception_step(Rover):
    ...
    Rover.vision_image[:, :, 0] = binary_obstacle
    Rover.vision_image[:, :, 1] = binary_rock
    Rover.vision_image[:, :, 2] = binary_nav
    ...
    x_rock, y_rock = img_helper.find_rock(warped_rock, ROCK_RADIUS)
